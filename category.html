...
<body>
  ...
  <div class="container-fluid ">
    ...
    <h1 class="r">Category</h1>
    <div class="a">
        <form class="row g-3 needs-validation" novalidate action="categorydb.jsp" method="post">
            <div class="col-md-4">
              <label for="validationCustom01" class="form-label b">price</label>
              <input type="text" class="form-control" name="price" id="validationCustom01" value="" required>
              
            </div>
            
           
            <div class="col-md-3">
              <label for="validationCustom04" class="form-label b">availability</label>
              <select class="form-select" name="availability" id="validationCustom04" required>
...
<footer class="text-center text-lg-start bg-body-tertiary text-muted foot kkk">
